  ...
  return (
    <div className='sorting'>
      <div className='sorting__icons'>
        <div className={!props.list ? 'sorting__image-container' : 'sorting__image-container sorting__image-container_active'} onClick={props.onList}>
          <img className='sorting__image' src={listIcon}/>
        </div>
        <div className={props.list ? 'sorting__image-container' : 'sorting__image-container sorting__image-container_active'} onClick={props.onNotList}>
          <img className='sorting__image' src={notListIcon}/>
        </div>
      </div>
      <div>
        <span className='sorting__description'>Сортировать по: </span>
        <select className='sorting__options' onChange={e => props.onChange(e.target.value)} value={props.value}>
